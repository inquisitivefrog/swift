...
1. **Safeway**
   - Icon: `cart.fill` or `storefront.fill`
   - Color: Red (#E31837)

2. **Whole Foods**
   - Icon: `leaf.fill` or `storefront.fill`
   - Color: Green (#00704A)

3. **Trader Joe's**
   - Icon: `storefront.fill` or `cart.fill`
   - Color: Orange (#E31837)
...
7. **Target**
   - Icon: `target` or `storefront.fill`
   - Color: Red
