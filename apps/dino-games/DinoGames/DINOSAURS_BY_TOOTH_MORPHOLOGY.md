# Dinosaurs Sorted by Tooth Morphology

From `DentalMorphology.swift`. Tooth types shown are those used in **Dino Smile** (`smileToothType`).

| Tooth morphology | Dinosaurs |
|------------------|-----------|
| **banana** | Albertosaurus, Majungasaurus, T-Rex |
| **diamond-battery** | Iguanodon, Ouranosaurus |
| **flute-leaf** | Huayangosaurus, Kentrosaurus, Stegosaurus |
| **forked-battery** | Chasmosaurus, Kosmoceratops, Styracosaurus, Torosaurus, Triceratops |
| **forward-spear** | Masiakasaurus |
| **grand-blade** | Acrocanthosaurus, Carcharodontosaurus, Giganotosaurus, Gigantosaurus |
| **heavy-peg** | Argentinosaurus, Rapetosaurus |
| **honeycomb-battery** | Corythosaurus, Edmontosaurus, Lambeosaurus, Maiasaura, Parasaurolophus |
| **hooked-blade** | Deinonychus, Dromaeosaurus, Utahraptor, Velociraptor |
| **hooked-needle** | Fukuiraptor, Troodon |
...
## Summary by tooth type (alphabetical)

| Tooth type | Count | Dinosaurs |
|------------|-------|-----------|
| banana | 3 | Albertosaurus, Majungasaurus, T-Rex |
| diamond-battery | 2 | Iguanodon, Ouranosaurus |
| flute-leaf | 3 | Huayangosaurus, Kentrosaurus, Stegosaurus |
| forked-battery | 5 | Chasmosaurus, Kosmoceratops, Styracosaurus, Torosaurus, Triceratops |
| forward-spear | 1 | Masiakasaurus |
| grand-blade | 4 | Acrocanthosaurus, Carcharodontosaurus, Giganotosaurus, Gigantosaurus |
| heavy-peg | 2 | Argentinosaurus, Rapetosaurus |
| honeycomb-battery | 5 | Corythosaurus, Edmontosaurus, Lambeosaurus, Maiasaura, Parasaurolophus |
| hooked-blade | 4 | Deinonychus, Dromaeosaurus, Utahraptor, Velociraptor |
| hooked-needle | 2 | Fukuiraptor, Troodon |
...
| scalloped-blade | 1 | Pachycephalosaurus |
