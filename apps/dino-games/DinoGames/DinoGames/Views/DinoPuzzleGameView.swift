...
//  Victory uses `VictorySplitColumnView` + `LandGameVictorySuccessStingerThenContinue` in `PortraitJigsawPuzzleGameView` (same success-card size as Name That Pterosaur / Which Ptero Is Taller).
//
